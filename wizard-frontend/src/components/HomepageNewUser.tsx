...
import { ArrowRight, Zap, BookOpen, ChevronLeft, ChevronRight, Plus } from "lucide-react";
    ...
    <div className="min-h-screen w-full bg-background flex items-center justify-center p-4">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid gap-6 sm:gap-8  md:grid-cols-2 max-w-4xl mx-auto">
          ...
          <Panel title={titleCreateConfig} content={"Jump directly to creating your mirrord.json configuration file"} buttonText={"Create Configuration Now"} buttonColor={"gray"} steps={[]} isReturning={isReturning} />
        </div>
      </div>
    </div>
  );
...
// TODO: move "learning" wizard steps somewhere else
